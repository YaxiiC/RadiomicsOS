# === ViT-B/16 3-Class Classifier: Patient-Level Split (Train: Case-3/P9/Case-48, Val: Case-48 slice, Test: Case-4) ===
...
BACKBONE   = "vit_base_patch16_224"   # <<< changed to ViT-B/16 (timm id)
...
DROP_RATE = 0.30            # standard dropout (applies to ViT head & MLP dropouts)
DROP_PATH_RATE = 0.10       # stochastic depth (supported by ViT in timm)
...
class CNNClassifier(nn.Module):
    def __init__(self, backbone: str, num_classes: int):
        ...
        # ViT supports both drop_rate & drop_path_rate in timm
        kwargs.update(dict(drop_rate=DROP_RATE, drop_path_rate=DROP_PATH_RATE))
